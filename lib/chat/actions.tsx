...
async function submitUserMessage(content: string) {
  ...
  const result = await streamUI({
    ...
    Return your responses in the following format: {ticker}:{action}:{quantity}:{price}

    Only respond with actions that the twitter post states with high confidence to take.
